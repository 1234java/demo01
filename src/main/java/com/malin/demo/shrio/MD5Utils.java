 ...
 * System.out.println(e.toString()); e.printStackTrace(); return ""; } char[]
 * charArray = inStr.toCharArray(); byte[] byteArray = new
 ...
 *//**
	 ...
	 *//*
		 ...
		 * 
		 * char[] a = inStr.toCharArray(); for (int i = 0; i < a.length; i++){ a[i] =
		 * (char) (a[i] ^ 't'); } String s = new String(a); return s; 
		 * 
		 *     }
		 * 
		 * // 测试主函数   public static void main(String args[]) { String s = new
		 * String("1111"); System.out.println("原始：" + s); System.out.println("MD5后：" +
